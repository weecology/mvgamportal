...
png(paste0("figures/simple_trace_",target,".png"), width = 2000, height = 2000) 
tryCatch({mcmc_plot(simple_model, type = 'trace', variable = 'trend_params')}, error = function(e) {message("An error occurred during plotting or saving: ", e$message)}) 
dev.off()